...
def validate_defects4j(reranked_result_path, output_path, tmp_dir):
    ...
    for key in reranked_result:
        ...
        # using for trans-d4j validate !
        project, path, start_loc, end_loc = key.split('@')
        proj = project.split('---')[0]
        bug_id = project.split('---')[1]
...
if __name__ == '__main__':
    ...
    for trans in trans_list:
        ...
        # print('#'*244)
        reranked_result_path = os.path.join(r'/home/lqy/cure/CURE_data/patches', trans, 'reranked_patches.json')
        output_path = os.path.join(r'/home/lqy/cure/CURE_data/final_output', trans, 'validated_patches.json')
        tmp_dir = r'/home/lqy/cure/Defects4J_project/'
