...
ids = [list(range(1, 41)), list(range(1, 19)), list(range(25, 29)), list(range(1, 48)), list(range(1, 17)), list(range(1, 27)), list(range(1, 58)), list(range(1, 7)), list(range(1, 94)), list(range(1, 23))]
